...
notify::_get_threshold_message() {
	...
	warning)
		...
		;;
	critical)
		echo "CRITICAL: Token usage at ${percent}% of context limit. You MUST start winding down your work now. You can leave uncommitted work the next agent will pick up from were you left off."
		;;
	danger)
